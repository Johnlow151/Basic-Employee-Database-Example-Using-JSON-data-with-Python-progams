...
class EmployeeDatabaseGUI:
    ...
    def __init__(self, root):
        ...
        try:
            ...
            # If file doesn't exist, create it with a default entry
            print("employees.json file not found. Creating new file with default entry.")
            self.example_dict = {
                "001": {
                    "Name": "John Smith",
                    "Age": 42,
            ...
            # Create the employees.json file with the default data
            with open('employees.json', 'w') as file:
                json.dump(self.example_dict, file, indent=4)
            self.display_output("employees.json file not found. Created new file with default entry.")
